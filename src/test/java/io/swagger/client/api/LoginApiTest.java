...
public class LoginApiTest {
    ...
    public void authorizeTest() throws Exception {
        ...
        String state = null;
        String scope = null;
        api.authorize(clientId, redirectUri, apiVersion, state, scope);
    ...
    public void logoutTest() throws Exception {
        String apiVersion = null;
        LogoutResponse response = api.logout(apiVersion);
    ...
    public void tokenTest() throws Exception {
        ...
        TokenResponse response = api.token(apiVersion, code, clientId, clientSecret, redirectUri, grantType);
