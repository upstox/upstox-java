...
public class ApiGatewayErrorResponse {
  ...
  public ApiGatewayErrorResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public ApiGatewayErrorResponse errors(List<Problem> errors) {
    this.errors = errors;
    return this;
  }

  public ApiGatewayErrorResponse addErrorsItem(Problem errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, apiGatewayErrorResponse.status) &&
        Objects.equals(this.errors, apiGatewayErrorResponse.errors);
  }
