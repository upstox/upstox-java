...
These files place neutral options trades on Nifty 50 using the Upstox Java SDK. Use them when you think the market is going to **stay in a range** — not move up or down significantly.
...
## Short Straddle — [code/ShortStraddle.java](code/ShortStraddle.java)
...
**Run:**
```bash
javac code/ShortStraddle.java && java -cp . ShortStraddle
```

---

## Short Strangle — [code/ShortStrangle.java](code/ShortStrangle.java)
...
**Run:**
```bash
javac code/ShortStrangle.java && java -cp . ShortStrangle
```

---

## Iron Butterfly — [code/IronButterfly.java](code/IronButterfly.java)
...
**Run:**
```bash
javac code/IronButterfly.java && java -cp . IronButterfly
```

---

## Batman — [code/Batman.java](code/Batman.java)
...
**Run:**
```bash
javac code/Batman.java && java -cp . Batman
```

---

## Short Iron Condor — [code/ShortIronCondor.java](code/ShortIronCondor.java)
...
**Run:**
```bash
javac code/ShortIronCondor.java && java -cp . ShortIronCondor
```
