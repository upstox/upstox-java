...
public class IronButterfly {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 2: Find the ATM put option (short put)
            ...
            // Step 3: Find the ATM+2 call option (long call wing)
            ...
            System.out.println("Long call  (ATM+2)  - Trading symbol : " + longCall.get("trading_symbol"));
            System.out.println("Long call  (ATM+2)  - Instrument key : " + longCall.get("instrument_key"));

            // Step 4: Find the ATM-2 put option (long put wing)
            ...
            System.out.println("Long put   (ATM-2)  - Trading symbol : " + longPut.get("trading_symbol"));
            System.out.println("Long put   (ATM-2)  - Instrument key : " + longPut.get("instrument_key"));
            ...
            System.out.println("Sell ATM CE order placed. Order ID: " + sellCallResult);
            ...
            System.out.println("Sell ATM PE order placed. Order ID: " + sellPutResult);
            ...
            System.out.println("Buy ATM+2 CE order placed. Order ID: " + buyCallResult);
            ...
            System.out.println("Buy ATM-2 PE order placed. Order ID: " + buyPutResult);
