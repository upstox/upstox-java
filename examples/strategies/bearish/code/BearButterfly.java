...
public class BearButterfly {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 1: Find the ATM put option (upper long)
            ...
            System.out.println("Upper long  (ATM)   - Trading symbol : " + upperLong.get("trading_symbol"));
            System.out.println("Upper long  (ATM)   - Instrument key : " + upperLong.get("instrument_key"));

            // Step 2: Find the ATM-1 put option (middle short)
            ...
            // Step 3: Find the ATM-2 put option (lower long)
            ...
            System.out.println("Lower long  (ATM-2)  - Trading symbol : " + lowerLong.get("trading_symbol"));
            System.out.println("Lower long  (ATM-2)  - Instrument key : " + lowerLong.get("instrument_key"));

            // Step 4: Buy the ATM put (upper long)
            ...
            System.out.println("Buy ATM PE order placed. Order ID: " + buyUpperResult);

            // Step 5: Sell 2x the ATM-1 put (middle short)
            ...
            System.out.println("Sell 2x ATM-1 PE order placed. Order ID: " + sellMiddleResult);

            // Step 6: Buy the ATM-2 put (lower long)
            ...
            System.out.println("Buy ATM-2 PE order placed. Order ID: " + buyLowerResult);
