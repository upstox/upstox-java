...
public class BearPutSpread {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 2: Find the ATM-1 put option (lower short)
            ...
            Map<String, Object> lowerShort = lowerInstruments.get(0);
            System.out.println("Lower short (ATM-1) - Trading symbol : " + lowerShort.get("trading_symbol"));
            System.out.println("Lower short (ATM-1) - Instrument key : " + lowerShort.get("instrument_key"));

            // Step 3: Buy the ATM put
            PlaceOrderV3Request buyOrder = new PlaceOrderV3Request();
            buyOrder.setInstrumentToken((String) upperLong.get("instrument_key"));
            buyOrder.setQuantity(((Double) upperLong.get("lot_size")).intValue());
            ...
            sellOrder.setInstrumentToken((String) lowerShort.get("instrument_key"));
            sellOrder.setQuantity(((Double) lowerShort.get("lot_size")).intValue());
