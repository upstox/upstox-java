...
These files place bearish options trades on Nifty 50 using the Upstox Java SDK. Use them when you think the market is going to go **down**.
...
## Buy Put — [code/BuyPut.java](code/BuyPut.java)
...
**Run:**
```bash
javac code/BuyPut.java && java -cp . BuyPut
```

---

## Sell Call — [code/SellCall.java](code/SellCall.java)
...
**Run:**
```bash
javac code/SellCall.java && java -cp . SellCall
```

---

## Bear Call Spread — [code/BearCallSpread.java](code/BearCallSpread.java)
...
**Run:**
```bash
javac code/BearCallSpread.java && java -cp . BearCallSpread
```

---

## Bear Put Spread — [code/BearPutSpread.java](code/BearPutSpread.java)
...
**Run:**
```bash
javac code/BearPutSpread.java && java -cp . BearPutSpread
```

---

## Bear Butterfly — [code/BearButterfly.java](code/BearButterfly.java)
...
**Run:**
```bash
javac code/BearButterfly.java && java -cp . BearButterfly
```

---

## Bear Condor — [code/BearCondor.java](code/BearCondor.java)
...
**Run:**
```bash
javac code/BearCondor.java && java -cp . BearCondor
```

---

## Long Calendar with Puts — [code/LongCalendarPut.java](code/LongCalendarPut.java)
...
**Run:**
```bash
javac code/LongCalendarPut.java && java -cp . LongCalendarPut
```

---

## Short Synthetic Future — [code/ShortSyntheticFuture.java](code/ShortSyntheticFuture.java)
...
**Run:**
```bash
javac code/ShortSyntheticFuture.java && java -cp . ShortSyntheticFuture
```

---

## Put Ratio Back Spread — [code/PutRatioBackSpread.java](code/PutRatioBackSpread.java)
...
**Run:**
```bash
javac code/PutRatioBackSpread.java && java -cp . PutRatioBackSpread
```

---

## Risk Reversal — [code/RiskReversal.java](code/RiskReversal.java)
...
**Run:**
```bash
javac code/RiskReversal.java && java -cp . RiskReversal
```
