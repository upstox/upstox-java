...
public class BullPutSpread {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 1: Find the ATM put option (upper short)
            ...
            System.out.println("Upper short (ATM)   - Trading symbol : " + upperShort.get("trading_symbol"));
            System.out.println("Upper short (ATM)   - Instrument key : " + upperShort.get("instrument_key"));

            // Step 2: Find the ATM-1 put option (lower long)
            ...
            System.out.println("Lower long  (ATM-1) - Trading symbol : " + lowerLong.get("trading_symbol"));
            System.out.println("Lower long  (ATM-1) - Instrument key : " + lowerLong.get("instrument_key"));

            // Step 3: Sell the ATM put (upper short)
            ...
            // Step 4: Buy the ATM-1 put (lower long)
