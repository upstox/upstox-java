...
public class LongIronButterfly {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 1: Find the ATM call option (long call)
            ...
            System.out.println("Long call  (ATM)   - Trading symbol : " + longCall.get("trading_symbol"));
            System.out.println("Long call  (ATM)   - Instrument key : " + longCall.get("instrument_key"));
            ...
            System.out.println("Long put   (ATM)   - Trading symbol : " + longPut.get("trading_symbol"));
            System.out.println("Long put   (ATM)   - Instrument key : " + longPut.get("instrument_key"));
            ...
            System.out.println("Buy ATM CE order placed. Order ID: " + buyCallResult);

            // Step 6: Buy the ATM put
            ...
            System.out.println("Buy ATM PE order placed. Order ID: " + buyPutResult);
