...
public class PutRatioSpread {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 1: Find the ATM put option (long put)
            ...
            System.out.println("Buy 1x ATM PE order placed. Order ID: " + buyResult);
            ...
            sellOrder.setQuantity(((Double) shortPut.get("lot_size")).intValue() * 2);
            ...
            System.out.println("Sell 2x ATM-1 PE order placed. Order ID: " + sellResult);
