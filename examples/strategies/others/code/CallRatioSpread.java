...
public class CallRatioSpread {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 2: Find the ATM+1 call option (short call)
            ...
            System.out.println("Buy 1x ATM CE order placed. Order ID: " + buyResult);
            ...
            sellOrder.setQuantity(((Double) shortCall.get("lot_size")).intValue() * 2);
            ...
            System.out.println("Sell 2x ATM+1 CE order placed. Order ID: " + sellResult);
