...
public class Strip {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 2: Find the ATM put option (long put x2)
            ...
            System.out.println("Buy 1x ATM CE order placed. Order ID: " + buyCallResult);
            ...
            buyPutOrder.setQuantity(((Double) longPut.get("lot_size")).intValue() * 2);
            ...
            System.out.println("Buy 2x ATM PE order placed. Order ID: " + buyPutResult);
